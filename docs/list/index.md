...
This version
: <http://rs.tdwg.org/dwc/doc/chrono/2026-05-26>
...
Abstract
: The Chronometric Age Vocabulary is an enhancement to the Darwin Core standard for transmitting information about chronometric ages - the processes and results of an assay or other analysis used to determine the age of a MaterialEntity. This document lists all terms in namespaces currently used in the vocabulary.
...
: TDWG Darwin Core Chronometric Age Extension Task Group. 2026. Chronometric Age Vocabulary List of Terms. Biodiversity Information Standards (TDWG). <http://rs.tdwg.org/dwc/doc/chrono/2026-05-26>
